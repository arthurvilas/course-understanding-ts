...
const userInputElement = document.getElementById(
    'user-input'
)! as HTMLInputElement; // ! tells TS that the expression will not return null

// without using ! we could

const userInputElement2 = document.getElementById('second-user-input');

if (userInputElement2) {
    (userInputElement2 as HTMLInputElement).value = 'Hi';
}
